    ...
    | $$  \ $$| $$      | $$  | $$| $$$/ \  $$$
    |  $$$$$$/| $$$$$$$$|  $$$$$$/| $$/   \  $$
     \______/ |________/ \______/ |__/     \__/ Datasheet v.2.0
...
SUB TABELL FOR ADJUST SETTING REQUEST [PC -> ARDUINO]
| Adjust Settings, Please  | Bytes |
|----------|-------|
| Adjust Mvmnt Sens + Light Duration by X and Y | 0xAA 0xAF **0x00** 0x(X) 0x(Y) 0xBB |
| Adjust Mvmnt Trig Alone by X   | 0xAA 0xAF **0x01** 0x(X) 0x00 0xBB |
| Adjust Light Duration Alone by X  | 0xAA 0xAF **0x02** 0x(X) 0x00 0xBB |
